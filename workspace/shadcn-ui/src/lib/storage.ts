...
const SAMPLE_EVENTS: Event[] = [
  {
    id: 'tech-fest-2025',
    name: 'Tech Fest 2025',
    description: 'Annual technology festival featuring latest innovations, workshops, and networking opportunities.',
  ...
  },
  {
    id: 'startup-summit',
    name: 'Startup Summit',
    description: 'Connect with entrepreneurs, investors, and industry leaders in this premier startup event.',
    date: '2025-02-20T10:00:00',
    location: 'Business Hub, Tech Park',
    organizerId: 'sample-organizer',
    createdAt: '2024-12-01T00:00:00.000Z',
    isActive: true,
  },
  ...
  },
  {
    id: 'sports-meet',
    name: 'Sports Meet',
    description: 'Inter-collegiate sports competition with various athletic events and competitions.',
  ...
  },
  {
    id: 'cultural-fest',
    name: 'Cultural Fest',
    description: 'Celebrate diversity through dance, music, art, and cultural performances from around the world.',
  ...
  try {
    ...
    if (!existingEvents) {
      ...
      SAMPLE_EVENTS.forEach(sampleEvent => {
        if (!events.find((e: Event) => e.id === sampleEvent.id)) {
          updatedEvents.push(sampleEvent);
          hasNewEvents = true;
        }
      });
...
export const getEvents = (): Event[] => {
  try {
    ...
    return data ? JSON.parse(data) : SAMPLE_EVENTS;
  } catch {
